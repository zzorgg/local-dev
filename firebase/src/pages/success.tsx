    ...
    <div className="min-h-svh flex items-center justify-center p-6">
      <div className="w-full max-w-3xl rounded-lg border p-6 shadow space-y-6">
        ...
        <div>
          ...
          <pre className="w-full rounded bg-muted p-3 text-xs whitespace-pre-wrap break-words">
            {idToken || "Loading..."}
          </pre>
        </div>
        ...
        <div>
          ...
          <pre className="rounded bg-muted p-3 text-xs overflow-x-auto">
            {decoded ? JSON.stringify(decoded.header, null, 2) : "Loading..."}
          </pre>
        </div>
        ...
        <div>
          ...
          <pre className="rounded bg-muted p-3 text-xs overflow-x-auto">
            {decoded ? JSON.stringify(decoded.payload, null, 2) : "Loading..."}
          </pre>
        </div>
